...
import 'SpicyDeals.dart';
import 'SpicyItems.dart';

class spicy extends StatefulWidget {
  const spicy({Key? key}) : super(key: key);

  @override
  State<spicy> createState() => _spicyState();
}

class _spicyState extends State<spicy> {
 @override
      ...
      body: Column(
        ...
        children: [
          CustomizeCard(context,
              Img: "assets/DealCardimages/img14.png",
              CenterTitle: "Items", onTapped: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Spicyitems(),
                ));
          }),
          SizedBox(
